          ...
          scope.activate(span, function() {
            ...
            return decompressMessageData(msg, function(err, msg) {
              ...
              req = {
                ...
                cid: msg.cid,
                model: msg.model,          // MODIFIED: Added model as part of the req object that gets passed to middleware
                modelOptions: msg.options, // user can pass an options object during sync
                method: method,            //   added check for method read/readAll
